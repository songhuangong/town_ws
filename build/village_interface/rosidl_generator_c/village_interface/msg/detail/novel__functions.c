...
{
  village_interface__msg__Novel * msg = (village_interface__msg__Novel *)malloc(sizeof(village_interface__msg__Novel));
  if (!msg) {
    return NULL;
  }
...
village_interface__msg__Novel__Sequence__init(village_interface__msg__Novel__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (village_interface__msg__Novel *)calloc(size, sizeof(village_interface__msg__Novel));
    if (!data) {
      return false;
    }
...
{
  village_interface__msg__Novel__Sequence * array = (village_interface__msg__Novel__Sequence *)malloc(sizeof(village_interface__msg__Novel__Sequence));
  if (!array) {
    return NULL;
  }

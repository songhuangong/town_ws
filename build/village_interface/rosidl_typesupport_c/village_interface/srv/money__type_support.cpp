...
static const _Money_Request_type_support_symbol_names_t _Money_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interface, srv, Money_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, village_interface, srv, Money_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, village_interface, srv, Money_Request)() {
  return &::village_interface::srv::rosidl_typesupport_c::Money_Request_message_type_support_handle;
}
...
static const _Money_Response_type_support_symbol_names_t _Money_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interface, srv, Money_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, village_interface, srv, Money_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_village_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, village_interface, srv, Money_Response)() {
  return &::village_interface::srv::rosidl_typesupport_c::Money_Response_message_type_support_handle;
}
...
static const _Money_type_support_symbol_names_t _Money_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interface, srv, Money)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, village_interface, srv, Money)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, village_interface, srv, Money)() {
  return &::village_interface::srv::rosidl_typesupport_c::Money_service_type_support_handle;
}
